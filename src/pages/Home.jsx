...
function Mothership() {
  return (
    <section className="py-12 sm:py-16 bg-[#F0E6DE]">
      <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-y-10 gap-x-[44px] px-4 md:grid-cols-20">
        <div className="md:col-span-7">
          ...
          <p className="mt-3 max-w-prose text-[25px] leading-relaxed text-[#99564c] text-justify">
        ...
        <div className="md:col-span-13 mt-6 md:mt-0">
          <img
...
function SoHackinEasy() {
  return (
    <section className="py-12 sm:py-16 bg-[#E6D7FF]">
      <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-y-10 gap-x-[44px] px-4 md:grid-cols-20">
        <div className="md:col-span-13 mb-6 md:mb-0">
          <img
        ...
        <div className="md:col-span-7">
          ...
          <p className="mt-3 max-w-prose text-[25px] leading-relaxed text-[#99564c] text-justify">
            ...
            techniques so hacking feels straightforward, not overwhelming.{" "}
            <em>Now</em>, the possibilities are truly endless.
          </p>
        </div>
      </div>
    </section>
  ...
  return (
    <section className="py-12 sm:py-16 bg-[#D4F4DD]">
      <div className="mx-auto grid max-w-7xl grid-cols-1 items-center gap-y-10 gap-x-[44px] px-4 md:grid-cols-20">
        ...
        <div className="md:col-span-13 md:order-2 mt-6 md:mt-0">
          <img
